                        ...
                        brands.map(brand => (
                          <tr key={brand.brandId}>
                            ...
                            <td className="flex gap-2 px-6 py-4 whitespace-no-wrap">
                              <Link href={`/brands/edit/brandId`} className="flex gap-1 items-center text-lg text-[#d40d9a] hover:text-[ #a00a7c] mr-2">
                              ...
                              <Link href={`/brands/delete/brandId`} className="flex gap-1 items-center text-lg text-red-600 hover:text-red-900">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
