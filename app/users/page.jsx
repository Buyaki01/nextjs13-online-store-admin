                    ...
                    <tr className="border-t border-gray-300">
                      ...
                      <td className="py-2 px-4 flex gap-2 justify-center">
                        <Link
                          ...
                          className="whitespace-nowrap flex gap-1 items-center rounded-md px-3 py-1 text-lg text-white bg-custom-green mr-2"
                        >
                        ...
                        <Link 
                          ...
                          className="whitespace-nowrap flex gap-1 items-center rounded-md px-3 py-1 text-lg text-white bg-red-500 mr-2"
                        >
